...
from ScanningTools import ScanningTools, Quaternions
...
class TestQuaternions(unittest.TestCase):
    def test_multiplication(self):
        ...
        p = Quaternions.Quaternion(5, 6, 7, 8)
    ...
    def test_rotation(self):
        ...
        rot = Quaternions.get_quaternion_from_rotation(np.pi/2, versor=(0, 0, 1))
        ...
        qrot = Quaternions.get_quaternion_from_rotation(np.pi, versor=u)
        z_versor = qrot.rotate_vector_by_quaternion(x_versor)
        self.assertTrue(np.allclose(z_versor(), Quaternions.get_quaternion_from_vector(z)()))
    ...
    def test_interpolation(self):
        ...
        interpolated_vectors = Quaternions.get_interpolation(x_versor, y_versor, t, t0, t1)
        # mp.figure()
    ...
    def test_euler_angles_rotation(self):
        ...
        qeulerrot = Quaternions.get_quaternion_from_euler(alpha, beta, gamma)
        ...
        qrot2 = Quaternions.get_quaternion_from_euler(np.pi/2, 0, 0)
