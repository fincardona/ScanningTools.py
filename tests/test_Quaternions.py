...
from ScanningTools import Quaternions as Q
...
class TestQuaternions(unittest.TestCase):
    def test_multiplication(self):
        q = Q.Quaternion(1, 2, 3, 4)
        p = Q.Quaternion(5, 6, 7, 8)
    ...
    def test_rotation(self):
        ...
        rot = Q.Quaternion.get_quaternion_from_rotation(np.pi/2, versor=(0, 0, 1))
        ...
        qrot = Q.Quaternion.get_quaternion_from_rotation(np.pi, versor=u)
        z_versor = qrot.rotate_vector_by_quaternion(x_versor)
        self.assertTrue(np.allclose(z_versor(), Q.Quaternion.get_quaternion_from_vector(z)()))
    ...
    def test_interpolation(self):
        ...
        interpolated_vectors = Q.Quaternion.get_interpolation(x_versor, y_versor, t, t0, t1)
        # mp.figure()
    ...
    def test_euler_angles_rotation(self):
        ...
        qeulerrot = Q.Quaternion.get_quaternion_from_euler(alpha, beta, gamma)
        ...
        qrot2 = Q.Quaternion.get_quaternion_from_euler(np.pi/2, 0, 0)
