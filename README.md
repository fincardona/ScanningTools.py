...
and a lot of others tools exploiting `astropy` to perform coordinates conversion. A module named `Quaternions.py` allows to perform all the operations with the Quaternions.
